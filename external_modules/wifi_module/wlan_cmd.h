...
extern int wlan_cmd_set_tx_mgmt(unsigned char vif_id, struct ieee80211_channel *channel, u8 dont_wait_for_ack, unsigned int wait, u64 *cookie, const unsigned char *mac, size_t mac_len);
